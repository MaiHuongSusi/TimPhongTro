...
public class MainActivityLamdung extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("baocao");
        databaseReference = mDatabase.child("lamdung");
    ...
    public void onClickGui() {
        ...
        if (str1.length() == 0) {
            Toast.makeText(MainActivityLamdung.this, "Hãy nhập Email.", Toast.LENGTH_LONG).show();

        } else {
            if (str2.length() == 0) {
                Toast.makeText(MainActivityLamdung.this, "Hãy nhập phản hồi.", Toast.LENGTH_LONG).show();
            } else {
                addDataToFirebase();
                Toast.makeText(MainActivityLamdung.this, "Đã gửi phản hồi.", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(MainActivityLamdung.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(MainActivityLamdung.this, MainActivity2.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(MainActivityLamdung.this, MainActivity4.class);
            startActivity(intent);

        } else if (id == R.id.dang_tim_ghep) {
            Intent intent = new Intent(MainActivityLamdung.this, MainActivity3.class);
            startActivity(intent);

        } else if (id == R.id.bao_cao) {
            Intent intent = new Intent(MainActivityLamdung.this, MainActivityTabBaocao.class);
            startActivity(intent);
        }
