...
public class MainActivityTabBaocao extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(MainActivityTabBaocao.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(MainActivityTabBaocao.this, MainActivity2.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(MainActivityTabBaocao.this, MainActivity4.class);
            startActivity(intent);

        } else if (id == R.id.dang_tim_ghep) {
            Intent intent = new Intent(MainActivityTabBaocao.this, MainActivity3.class);
            startActivity(intent);
