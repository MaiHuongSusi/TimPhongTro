...
public class MainActivitySuco extends AppCompatActivity
    ...
    public void onClickGui() {
        ...
        if (str1.length() == 0) {
            Toast.makeText(MainActivitySuco.this, "Hãy nhập Email.", Toast.LENGTH_LONG).show();

        } else {
            if (str2.length() == 0) {
                Toast.makeText(MainActivitySuco.this, "Hãy nhập phản hồi.", Toast.LENGTH_LONG).show();
            } else {
                addDataToFirebase();
                Toast.makeText(MainActivitySuco.this, "Đã gửi phản hồi.", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(MainActivitySuco.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(MainActivitySuco.this, MainActivity2.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(MainActivitySuco.this, MainActivity4.class);
            startActivity(intent);

        } else if (id == R.id.dang_tim_ghep) {
            Intent intent = new Intent(MainActivitySuco.this, MainActivity3.class);
            startActivity(intent);

        } else if (id == R.id.bao_cao) {
            Intent intent = new Intent(MainActivitySuco.this, MainActivityTabBaocao.class);
            startActivity(intent);
        }
